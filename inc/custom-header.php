 ...
 *
 * @uses fresh_start_header_style()
 */
function fresh_start_custom_header_setup() {
  add_theme_support( 'custom-header', apply_filters( 'fresh_start_custom_header_args', array(
    'default-image'          => '',
 ...
 *
 * @see fresh_start_custom_header_setup().
 */
function fresh_start_header_style() {
